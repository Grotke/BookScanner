...
public class TestBookScannerDbHelper extends SQLiteOpenHelper {
    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME = "TestBookScanner.db";
    ...
    public TestBookScannerDbHelper(Context context){
